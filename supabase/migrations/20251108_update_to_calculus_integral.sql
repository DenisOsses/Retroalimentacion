/*
  # Update course from Cálculo Diferencial to Cálculo Integral

  1. Changes Made
    - Update course name and description from Differential Calculus to Integral Calculus
    - Replace all assessment topics with Integral Calculus topics
    - All 14 topics specific to integral calculus with their descriptors

  2. Topics Added
    - Integración por fracciones parciales
    - Integración por métodos trigonométricos
    - Área entre curvas
    - Volumen de un sólido (4 variations)
    - Centroide de una región plana
    - Longitud de una curva (cartesian and parametric)
  ...
  3. Data Safety
    ...
    - Only course name/description and topics are updated
